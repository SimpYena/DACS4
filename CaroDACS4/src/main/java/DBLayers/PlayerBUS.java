...
public class PlayerBUS {
    ...
    ArrayList<PlayerDTO> listPlayer = new ArrayList<>();
    ...
    public ArrayList<PlayerDTO> getList() {
        return listPlayer;
    }
    ...
    public String signup(String email, String password, String avatar, String name, String gender, int yearOfBirth) {
        ...
        // thêm vào db
        boolean status = add(new PlayerDTO(email, password, avatar, name, gender, yearOfBirth));
        if (!status) {
            // lỗi ko xác định
