...
public class Client implements Runnable {
    ...
    private void onReceiveGetProfile(String received) {
        ...
        // get player data
        PlayerDTO p = new PlayerBUS().getByEmail(email);
        if (p == null) {
            ...
            case MOVE:
                ...
                if (caroGame.move(row, column, loginPlayer.getEmail())) {
                    ...
                    if (winPath != null) {
                        ...
                        PlayerDTO winner = loginPlayer;
                        PlayerDTO loser = cCompetitor.loginPlayer;
    ...
    public PlayerDTO getLoginPlayer() {
        return loginPlayer;
    }

    public void setLoginPlayer(PlayerDTO loginPlayer) {
